...
class DoryMembershipConan(ConanFile):
    name = "dory-membership"
    version = "0.0.1"
    license = "MIT"
    # url = "TODO"
    description = "RDMA membership"
    settings = {
        "os": None,
        "compiler": {
    ...
    def requirements(self):
        ...
        self.requires("dory-paxos/0.0.1")
    ...
    def package(self):
        self.copy("*", dst="bin", src="bin")
        self.copy("*.hpp", dst="include/dory/membership", src="src")
